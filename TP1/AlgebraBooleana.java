...
public class AlgebraBooleana {
    ...
    public static int avaliarSubString(String str) {
        ...
        if(commaIndex != -1){
            if(commaCount(str) > 1 || countOpeningParenthesis(str) > 1){
                if(str.startsWith("and(")){
                    ...
                    int op1 = avaliarSubString(subStr1);
                    int op2 = avaliarSubString(subStr2);
                    return (op1 == 1 && op2 == 1) ? 1 : 0;
                } else if(str.startsWith("not(")){
                    int indexFechamento = findClosingParenthesis(str);
                    int value = avaliarSubString(str.substring(4, indexFechamento));
                    return (value == 1) ? 0 : 1;
            ...
            int indexFechamento = findClosingParenthesis(str);
            int op = avaliarSubString(str.substring(4, indexFechamento));
            return (op == 0) ? 1 : 0;
        } else {
            int valor = Integer.parseInt(str);
            return valor;
    ...
    public static void BooleanLogic(String str) {
        ...
        System.out.println(avaliarSubString(str));
    }
